...
// 🛠️ RENAMED class to PropertyGuestDetailsScreen to avoid conflicts
class PropertyGuestDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> propertyData;
  final int suiteId;
  final DateTime fromDate;
  final DateTime toDate;

  const PropertyGuestDetailsScreen({
    super.key,
  ...
  @override
  State<PropertyGuestDetailsScreen> createState() => _PropertyGuestDetailsScreenState();
}

class _PropertyGuestDetailsScreenState extends State<PropertyGuestDetailsScreen> {
