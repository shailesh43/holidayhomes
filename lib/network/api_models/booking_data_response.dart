class BookingDataResponse {
  ...
  BookingDataResponse({this.success, this.data});

  BookingDataResponse.fromJson(Map<String, dynamic> json) {
...
class BookingData {
  ...
  // 🛠️ FIXED: Changed explicitly 'Null' types to 'dynamic' to prevent crashes
  ...
  // 🛠️ FIXED: Changed explicitly 'Null' types to 'dynamic'
  ...
  BookingData({
    ...
    this.hdHomeBookingEmpemail,
    this.hdHomeBookingEmpmob,
    this.hdHomeBookingEmpdept,
    this.hdHomeBookingEmpdesig,
    this.hdHomeBookingEmpcostcent,
    ...
    this.hdHomeBookingBY,
    this.hdHomeBookingRating,
    this.hdHomeBookingFeedback,
    this.hdHomeBookingStatus,
    this.hdHomeBookByEmpno,
    this.hdHomeBookByEmpName,
    this.hdHomeBookByEmail,
    this.hdHomeBookingActive,
    this.hdHomeBookingInsBy,
    this.hdHomeBookingInsDate,
    this.hdHomeBookingStatusCd,
    this.bookingStatus,
    this.hdHomeCheckin,
    this.hdHomeCheckindt,
    this.hdHomeCheckinby,
    this.hdHomeCaretakername,
    this.hdHomeCaretakerEmail,
    this.hdHomeCaretakerMobile,
  });
  ...
  Map<String, dynamic> toJson() {
    ...
    data['hd_homeloc_cd'] = hdHomelocCd;
    data['hd_loc_name'] = hdLocName;
    data['hd_home_cd'] = hdHomeCd;
    data['hd_home_name'] = hdHomeName;
    data['hd_home_suite_cd'] = hdHomeSuiteCd;
    data['hd_home_suite_name'] = hdHomeSuiteName;
    data['hd_home_suite_catg'] = hdHomeSuiteCatg;
    data['hd_home_booking_empno'] = hdHomeBookingEmpno;
    data['hd_home_booking_empname'] = hdHomeBookingEmpname;
    data['hd_home_booking_empemail'] = hdHomeBookingEmpemail;
    data['hd_home_booking_empmob'] = hdHomeBookingEmpmob;
    data['hd_home_booking_empdept'] = hdHomeBookingEmpdept;
    data['hd_home_booking_empdesig'] = hdHomeBookingEmpdesig;
    data['hd_home_booking_empcostcent'] = hdHomeBookingEmpcostcent;
    data['hd_home_booking_fromdt'] = hdHomeBookingFromdt;
    data['hd_home_booking_todt'] = hdHomeBookingTodt;
    data['hd_home_booking_iscancel'] = hdHomeBookingIscancel;
    data['hd_home_booking_canceldt'] = hdHomeBookingCanceldt;
    data['hd_home_booking_cancel_b_y'] = hdHomeBookingCancelBY;
    data['hd_home_booking_cancelremark'] = hdHomeBookingCancelremark;
    data['hd_home_booking_waiting'] = hdHomeBookingWaiting;
    data['hd_home_booking_currwaiting'] = hdHomeBookingCurrwaiting;
    data['hd_home_booking_b_y'] = hdHomeBookingBY;
    data['hd_home_booking_rating'] = hdHomeBookingRating;
    data['hd_home_booking_feedback'] = hdHomeBookingFeedback;
    data['hd_home_booking_status'] = hdHomeBookingStatus;
    data['hd_home_book_by_empno'] = hdHomeBookByEmpno;
    data['hd_home_book_by_emp_name'] = hdHomeBookByEmpName;
    data['hd_home_book_by_email'] = hdHomeBookByEmail;
    data['hd_home_booking_active'] = hdHomeBookingActive;
    data['hd_home_booking_ins_by'] = hdHomeBookingInsBy;
    data['hd_home_booking_ins_date'] = hdHomeBookingInsDate;
    data['hd_home_booking_status_cd'] = hdHomeBookingStatusCd;
    data['booking_status'] = bookingStatus;
    data['hd_home_checkin'] = hdHomeCheckin;
    data['hd_home_checkindt'] = hdHomeCheckindt;
    data['hd_home_checkinby'] = hdHomeCheckinby;
    data['hd_home_caretakername'] = hdHomeCaretakername;
    data['hd_home_caretaker_email'] = hdHomeCaretakerEmail;
    data['hd_home_caretaker_mobile'] = hdHomeCaretakerMobile;
    return data;
  }
}